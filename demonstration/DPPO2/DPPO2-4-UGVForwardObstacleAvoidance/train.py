...
from UGVForwardObstacleAvoidance import UGVForwardObstacleAvoidance
...
ENV = 'UGVForwardObstacleAvoidance'
ALGORITHM = 'DPPO2'
...
if __name__ == '__main__':
    ...
    if RETRAIN:
        agent.global_actor.load_state_dict(torch.load('actor'))
        agent.global_critic.load_state_dict(torch.load('critic'))
